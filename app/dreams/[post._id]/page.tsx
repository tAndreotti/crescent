...
const Dreams = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`https://crescent-api.vercel.app/posts/${postId}`);
        ...
        const friendsResponse = await axios.get(`https://crescent-api.vercel.app/users/${user._id}/friends`);
  ...
  const handleDelete = async () => {
    try {
      ...
      await axios.delete(`https://crescent-api.vercel.app/posts/${myId}/${postId}`, { withCredentials: true });
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const postId = window.location.pathname.split('/').pop();
      const response = await axios.patch(`https://crescent-api.vercel.app/posts/${myId}/${postId}`, {
        text,
